...
const openAttempt = async (a) => {
  ...
  // ── Full-page loader while dashboard data is fetching ──
  ...
  return (
    <div style={{ padding: "24px 28px", maxWidth: 1100, margin: "0 auto" }}>
      ...
      <span style={{ fontSize: 13, fontWeight: 600, color: "var(--white)", letterSpacing: 0.3 }}>
        Leaderboard
      </span>
              ...
              lbShow.map((s, i) => (
                <div
                  ...
                  style={{
                    ...
                    border: `1px solid ${s.isMe ? "rgba(240,165,0,0.18)" : "transparent"}`,
                    borderRadius: "var(--radius)",
                  }}
                >
                  <span style={{ width: 17, fontSize: 11, fontWeight: 700, color: s.rank <= 3 ? "var(--amber)" : "var(--muted)", textAlign: "center" }}>
                    {s.rank}
                  </span>
                  <div style={{ width: 26, height: 26, borderRadius: "50%", background: s.isMe ? "var(--amber)" : "var(--surface2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 700, color: s.isMe ? "#0C0E14" : "var(--muted)", flexShrink: 0 }}>
                    {s.initials}
                  </div>
                  <span style={{ flex: 1, fontSize: 12, color: s.isMe ? "var(--amber)" : "var(--body)", fontWeight: s.isMe ? 600 : 400 }}>
                    {s.name}
                  </span>
